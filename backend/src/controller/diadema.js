...
export class diadema {
    constructor(diadema, marca, fk_estado, idBuscado) {
...
], diadema.prototype, "id_diadema", void 0);
__decorate([
...
], diadema.prototype, "marca_diadema", void 0);
__decorate([
    IsInt(),
    ...
    Transform(({ value }) => {
        if (/^[0-9]+$/.test(value) || typeof value == "undefined")
            ...
            throw { status: 400, message: "el dato del estado_diadema ingresado es incorrecto, ingresa un número entero" };
    }, { toClassOnly: true }),
    __metadata("design:type", Number)
], diadema.prototype, "estado_diadema", void 0);
__decorate([
    IsInt(),
    Expose({ name: "id" }),
    Transform(({ value }) => {
