...
export class Pantalla {
    constructor(pantalla, marca, fk_estado, idBuscado) {
...
], Pantalla.prototype, "id_pantalla", void 0);
__decorate([
...
], Pantalla.prototype, "marca_pantalla", void 0);
__decorate([
    IsInt(),
    ...
    Transform(({ value }) => {
        if (/^[0-9]+$/.test(value) || typeof value == "undefined")
            ...
            throw { status: 400, message: "el dato del estado_pantalla ingresado es incorrecto, ingresa un número entero" };
    }, { toClassOnly: true }),
    __metadata("design:type", Number)
], Pantalla.prototype, "estado_pantalla", void 0);
__decorate([
    IsInt(),
    Expose({ name: "id" }),
    Transform(({ value }) => {
